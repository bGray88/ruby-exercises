RSpec.describe 'Count Pattern Test' do
  ...
  it 'even numbers' do
    ...
    tally = 0
    numbers.each {|i| i % 2 == 0 ? tally += 1 : nil}
  ...
  it 'multiples of 5' do
    ...
    tally = 0
    numbers.each {|i| i % 5 == 0 ? tally += 1 : nil}
    expect(tally).to eq(3)
  end
  ...
  it 'round prices' do
    ...
    tally = 0
    prices.each {|i| i % 1 == 0 ? tally += 1 : nil}
    expect(tally).to eq(2)
  end
  ...
  it 'four letter words' do
    ...
    tally = 0
    words.each {|i| i.length == 4 ? tally += 1 : nil}
