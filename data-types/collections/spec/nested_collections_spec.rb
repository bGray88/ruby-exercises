RSpec.describe 'Nested Collections' do
  ...
  it 'test 2' do
    ...
    thirty_nine = coordinates.rassoc(39).find {|i| i == 39}
  ...
  it 'test 11' do
    ...
    actual = three_day_forecast.rassoc(3456789765456787656).find {|i| i == 3456789765456787656}
  ...
  it 'test 15' do
    ...
    actual = three_day_forecast[:days].each do |day|
      if day.rassoc(55)
        break day.rassoc(55).find {|i| i == 55} if day.rassoc(55).find {|i| i == 55}
      end
    end
    expected = 55
    expect(actual).to eq(expected)
  ...
  it 'test 18' do
    ...
    actual = three_day_forecast.keys.find {|i| i == "date"}
    expected = "date"
    expect(actual).to eq(expected)
  end
